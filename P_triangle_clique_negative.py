...
save_dict(times_simulation_edges, 'P_triangle_clique_P_'+str(int(100*a))+'_'+str(int(100*b)))
save_dict(weights, 'P_triangle_clique_P_weight_'+str(int(100*a))+'_'+str(int(100*b)))