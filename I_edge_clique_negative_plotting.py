...
times = load_dict('I_edge_clique_I_'+str(int(100*B))+'_'+str(int(100*C))).tolist()[0]
weights = load_dict('I_edge_clique_I_weight_'+str(int(100*B))+'_'+str(int(100*C)))
...
plt.tight_layout()
plt.savefig('I_edge_clique_I_'+str(int(100*B))+'_'+str(int(100*C))+'.pdf',dpi=300)
plt.show()