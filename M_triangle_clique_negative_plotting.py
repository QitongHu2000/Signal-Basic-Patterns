...
times = load_dict('M_triangle_clique_M_'+str(int(100*B))+'_'+str(int(100*C))).tolist()[0]
weights = load_dict('M_triangle_clique_M_weight_'+str(int(100*B))+'_'+str(int(100*C)))
...
plt.tight_layout()
plt.savefig('M_triangle_clique_M_'+str(int(100*B))+'_'+str(int(100*C))+'.pdf',dpi=300)
plt.show()