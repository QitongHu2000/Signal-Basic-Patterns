...
save_dict(times_simulation_edges, 'I_edge_clique_I_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(weights, 'I_edge_clique_I_weight_'+str(int(100*B))+'_'+str(int(100*C)))