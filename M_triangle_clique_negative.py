...
save_dict(times_simulation_edges, 'M_triangle_clique_M_'+str(int(100*B))+'_'+str(int(100*C)))
save_dict(weights, 'M_triangle_clique_M_weight_'+str(int(100*B))+'_'+str(int(100*C)))
